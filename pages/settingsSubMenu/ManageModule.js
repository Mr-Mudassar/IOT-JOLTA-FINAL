  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-4 my-6">
        ...
        <table className="table table-sm border-2">
          <thead>
            <tr>
              ...
              <th className='border-2'>Cutomer Name</th>
      ...
      <div className='bg-green-500 text-md text-center'>
        <button onClick={showAddUser} className='text-white p-3'>Add New Module +</button>
      </div>
      ...
      {editingUser && (
          ...
          <div className="bg-white p-4 rounded-md shadow-md shadow-black border border-stone-800">
            ...
            <div className='m-4'>
              <label className='font-semibold'>Voltage (cap): </label>
              <input
                type='text'
                name='lastLogin'
            ...
            <div className='m-4'>
              <label className='font-semibold'>Power (cap): </label>
              <input
                type='text'
                name='favoriteColor'
